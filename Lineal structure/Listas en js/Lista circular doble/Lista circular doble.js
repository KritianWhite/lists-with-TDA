...
listaCanciones.agregarAlfinal(new Canciones("Imagination", "Para fumar mota", 5))
listaCanciones.agregarAlfinal(new Canciones("Inside of my eyelids", "Para fumar mota", 2))
...
listaCanciones.agregarAlfinal(new Canciones("Instant crush", "Contemporanea", 5))
console.log(listaCanciones.buscar("Starboy"))
